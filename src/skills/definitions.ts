...
===== 输出要求 =====
1. 直接以 Markdown 一级标题开始输出正文：第一行写「# 章节标题」
2. **章节标题格式必须统一**：一律用「第N章 标题」且 N 用阿拉伯数字（如「第6章 归途」「第7章 暗涌」），不要用中文数字（不要写"第六章"），不要用「第N卷」作为章节标题，不要重复卷标题
3. 紧接着输出正文（不要包含任何创作说明、不要写"以下是..."之类的引导语）
4. 正文文风贴近原著节选，人物口吻、节奏与原著一致`,
  },
  {
    id: "reference-plot",
    name: "借鉴剧情",
