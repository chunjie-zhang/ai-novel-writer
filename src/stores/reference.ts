...
export const useReferenceStore = defineStore("reference", () => {
  ...
  const referenceContext = computed(() => {
    ...
    // 约束：延续原著的设定体系与剧情脉络，但名词与字句必须原创、并加入自己的巧思
    ctx += `\n【重要约束】以上原著大纲、节选与分析用于把握原著的设定体系与剧情脉络。仿写续写时：\n`;
    ctx += `1. 原著中所有专有名词（人物名、地名、国家、势力、组织、境界、功法、法宝、称号等）一律换成全新名字，不得沿用任何一个；\n`;
    ctx += `2. 严禁复制或改写原著原文的任何句子、短语、描写，全部用全新语言表达；\n`;
    ctx += `3. 需要延续的是原著的**设定体系**（世界观底色、力量体系规则、势力格局、人物身份关系）与**剧情脉络**（主线走向、核心事件序列、起承转合），在此基础上主动加入你自己的角色塑造、情节设计、细节桥段与情感刻画等创作巧思，让作品既有原著的骨架与味道，又有你个人的亮点。`;
